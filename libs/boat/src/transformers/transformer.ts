import { Transformer$IncludeMethodOptions } from '@libs/boat';
import { Context } from '@libs/boat';
...
export abstract class Transformer {
  ...
  parseIncludes(include = ''): this {
    this.includes = {
      ...ExpParser.from(include).toObj(),
      ...ExpParser.from(this.defaultIncludes.join(',')).toObj(),
    };
    return this;
  }
